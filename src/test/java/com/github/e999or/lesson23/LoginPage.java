...
public class LoginPage {
    @Step("пользователь вводи в адресную строку браузера: \"https://idemo.bspb.ru\"")
    LoginPage open() {
        Selenide.open("https://idemo.bspb.ru");
        return this;
    }

    @Step("нажимает клавишу \"Войти\"")
    LoginPage clickLoginButton() {
        $(By.id("login-button")).click();
        return this;
    }

    @Step("появляется окно 2х факторной идентификации провеорить есть ли на странице :\"*1111\"")
    ...
    @Step("в поле ввода кода ввести:\"0000\"")
